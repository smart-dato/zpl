...
trait CanSetBarcodeDefaults
{
    ...
    public function withBarcodeDefaults(
        ?int $moduleWidth = null,
        ?float $wideNarrowWidthRatio = null,
    ...
    {
        return BarcodeDefaultsCommand::render(
            $this->moduleWidthDefault,
            $this->wideNarrowWidthRatioDefault,
            $this->barcodeHeightDefault
        );
    }
}
